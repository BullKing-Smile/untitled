...
> Apache Dubbo 是一款高性能、轻量级的 Java <font color=red>***RPC***</font>（远程过程调用）框架，
...
3.x 引入了全新的<font color=green>***基于应用粒度的服务发现机制***</font>

新模式具有两大优势
1. <font color=red>***性能和稳定性 提升， 大幅度提高系统资源利用率； 单机内存消耗降低50%； 注册中心集群的存储和推送压力降低90%； 集群规模步入 百万实例级别***</font>
